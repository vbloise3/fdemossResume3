...
export class Material2AppAppComponent {
  ...
  rootStuff: Object;
  title = 'fdemossResume3Ui';
  lastDialogResult: string;
  myEmail: string = 'fdemoss26@gmail.com';
  ...
  template: `
          ...
          <table>
              <tr [class.App-buttons-mobile]='deviceWidthCss == "App-name-mobile"'>
                <td><a href="mailto:fdemoss26@gmail.com?Subject=Resume" style="color: blue;"><i class="material-icons md-18 iconBottom">email</i>fdemoss26@gmail.com</a></td>
                <td><a href="tel:973-294-0176" style="color: blue"><i class="material-icons md-18 iconBottom">phone_iphone</i>973-294-0176</a></td>
              </tr>
          </table>
          <div class="centerIt2">
